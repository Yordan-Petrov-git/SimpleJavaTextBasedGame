...
public class Miner extends Enemy {
    ...
    public Miner(String name, EnumEntityClass entityClass, int entityRace, int entityLevel, double health, double mana, double stamina
        ...
        super(name, entityClass, entityRace, entityLevel, health, mana, stamina, movementSpeed, attackDamage, abilityPower
                ...
                , fireResist, frostResist, shockResist, souls, hunger, isEntityBoss, dropAmountExperience, dropAmountGold
                , dropAmountItems);
    }
}
