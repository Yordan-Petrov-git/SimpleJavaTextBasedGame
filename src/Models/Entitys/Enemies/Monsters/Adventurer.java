...
public class Adventurer extends Enemy {
    ...
    public Adventurer(String name, int entityClass, int entityRace, int entityLevel, double health, double mana
            ...
            , double shockResist, double souls, double hunger, boolean isEntityBoss, double dropAmountExperience, double dropAmountGold
            , double dropAmountItems) {
        ...
        super(name, entityClass, entityRace, entityLevel, health, mana, stamina, movementSpeed, attackDamage, abilityPower, attackSpeed
                ...
                , slashResist, punctureResist, magickResist, holyResist, darkResist, fireResist, frostResist, shockResist, souls, hunger, isEntityBoss
                , dropAmountExperience, dropAmountGold, dropAmountItems);
